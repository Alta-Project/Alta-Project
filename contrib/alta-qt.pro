...
RESOURCES += src/qt/alta.qrc src/qt/alta_locale.qrc

TRANSLATIONS += src/qt/locale/alta_bg.ts \
                src/qt/locale/alta_de.ts \
                src/qt/locale/alta_en.ts \
                src/qt/locale/alta_es.ts \
                src/qt/locale/alta_fi.ts \
                src/qt/locale/alta_fr.ts \
                src/qt/locale/alta_it.ts \
                src/qt/locale/alta_ja.ts \
                src/qt/locale/alta_pl.ts \
                src/qt/locale/alta_pt.ts \
                src/qt/locale/alta_ru.ts \
                src/qt/locale/alta_sk.ts \
                src/qt/locale/alta_sv.ts \
                src/qt/locale/alta_vi.ts \
                src/qt/locale/alta_zh_CN.ts \
                src/qt/locale/alta_zh_TW.ts
