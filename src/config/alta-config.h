/* src/config/alta-config.h.  Generated from alta-config.h.in by configure.  */
/* src/config/alta-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ALTA_CONFIG_H

#define ALTA_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://alta.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Alta Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Alta Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "alta"
