...
#if defined(NDEBUG)
#error "Alta cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Alta Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if (nHeight == 0) return 78000 * COIN;
        else if (nHeight >= 1 && nHeight <= 2500) return 1 * COIN;
	else if (nHeight >= 2501 && nHeight <= 3500) return 5 * COIN;
