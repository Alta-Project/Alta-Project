...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Alta address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and alta: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    coinmixAction = new QAction(QIcon(":/icons/coinmix"), tr("&StealthSend"), this);
    coinmixAction->setStatusTip(tr("Show general StealthSend section of wallet"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Alta Core"), this);
    aboutAction->setStatusTip(tr("Show information about Alta Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Alta"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Alta addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Alta addresses"));
    ...
    openAction->setStatusTip(tr("Open a Alta: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Alta Core help message to get a list with possible Alta command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Alta Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Alta network", "", count));
}
...
{
    QString strTitle = tr("Alta Core"); // default title
...
void BitcoinGUI::setStakingStatus()
{
    ...
    if (nLastCoinStakeSearchInterval) {
        ...
        labelStakingIcon->setToolTip(tr("Multichain is not active\n MultiSend: %1").arg(fMultiSend ? tr("Active") : tr("Not Active")));
    } else {
        labelStakingIcon->show();
