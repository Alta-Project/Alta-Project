...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ALTA features */
        {"alta", "masternode", &masternode, true, true, false},
        {"alta", "masternodelist", &masternodelist, true, true, false},
        {"alta", "mnbudget", &mnbudget, true, true, false},
        {"alta", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"alta", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"alta", "mnsync", &mnsync, true, true, false},
        {"alta", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"alta", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use altad, or the -server option to alta-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> alta-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:28910/\n";
}
